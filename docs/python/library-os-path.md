---
sourceUrl: https://docs.python.org/3/library/os.path.html
...
files see `open()`, and for accessing the filesystem see the `os`
...
Changed in version 3.14: The `ALLOW_MISSING` value for the strict parameter
was added.
