---
sourceUrl: https://docs.python.org/3/reference/simple_stmts.html
fetchedAt: "2026-04-19T23:59:00Z"
language: python
section: reference
---

# 7. Simple statements[¶](#simple-statements)
...
**simple_stmt**: [`expression_stmt`](#grammar-token-python-grammar-expression_stmt)
| [`assert_stmt`](#grammar-token-python-grammar-assert_stmt)
| [`assignment_stmt`](#grammar-token-python-grammar-assignment_stmt)
| [`augmented_assignment_stmt`](#grammar-token-python-grammar-augmented_assignment_stmt)
| [`annotated_assignment_stmt`](#grammar-token-python-grammar-annotated_assignment_stmt)
| [`pass_stmt`](#grammar-token-python-grammar-pass_stmt)
| [`del_stmt`](#grammar-token-python-grammar-del_stmt)
| [`return_stmt`](#grammar-token-python-grammar-return_stmt)
| [`yield_stmt`](#grammar-token-python-grammar-yield_stmt)
| [`raise_stmt`](#grammar-token-python-grammar-raise_stmt)
| [`break_stmt`](#grammar-token-python-grammar-break_stmt)
| [`continue_stmt`](#grammar-token-python-grammar-continue_stmt)
| [`import_stmt`](#grammar-token-python-grammar-import_stmt)
| [`future_stmt`](#grammar-token-python-grammar-future_stmt)
| [`global_stmt`](#grammar-token-python-grammar-global_stmt)
| [`nonlocal_stmt`](#grammar-token-python-grammar-nonlocal_stmt)
| [`type_stmt`](#grammar-token-python-grammar-type_stmt)

```

## 7.1. Expression statements[¶](#expression-statements)
...
**expression_stmt**: [`starred_expression`](expressions.html#grammar-token-python-grammar-starred_expression)
...
using the built-in [`repr()`](../library/functions.html#repr) function and the resulting string is written to
standard output on a line by itself (except if the result is `None`, so that
procedure calls do not cause any output.)

## 7.2. Assignment statements[¶](#assignment-statements)
...
**assignment_stmt**: ([`target_list`](#grammar-token-python-grammar-target_list) "=")+ ([`starred_expression`](expressions.html#grammar-token-python-grammar-starred_expression) | [`yield_expression`](expressions.html#grammar-token-python-grammar-yield_expression))
**target_list**: [`target`](#grammar-token-python-grammar-target) ("," [`target`](#grammar-token-python-grammar-target))* [","]
**target**: [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier)
| "(" [[`target_list`](#grammar-token-python-grammar-target_list)] ")"
| "[" [[`target_list`](#grammar-token-python-grammar-target_list)] "]"
| [`attributeref`](expressions.html#grammar-token-python-grammar-attributeref)
| [`subscription`](expressions.html#grammar-token-python-grammar-subscription)
| "*" [`target`](#grammar-token-python-grammar-target)
...
if this is not the case, [`TypeError`](../library/exceptions.html#TypeError) is raised. That object is then
...
properties created with [`property()`](../library/functions.html#property).

* If the target is a subscription: The primary expression in the reference is
evaluated.
Next, the subscript expression is evaluated.
Then, the primary’s [`__setitem__()`](datamodel.html#object.__setitem__) method is called with
two arguments: the subscript and the assigned object.

Typically, [`__setitem__()`](datamodel.html#object.__setitem__) is defined on mutable sequence objects
...
its item with that index. If the index is out of range, [`IndexError`](../library/exceptions.html#IndexError) is
...
The assigned object should be [iterable](../glossary.html#term-iterable).
...
### 7.2.1. Augmented assignment statements[¶](#augmented-assignment-statements)
...
**augmented_assignment_stmt**: [`augtarget`](#grammar-token-python-grammar-augtarget) [`augop`](#grammar-token-python-grammar-augop) ([`expression_list`](expressions.html#grammar-token-python-grammar-expression_list) | [`yield_expression`](expressions.html#grammar-token-python-grammar-yield_expression))
**augtarget**: [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier) | [`attributeref`](expressions.html#grammar-token-python-grammar-attributeref) | [`subscription`](expressions.html#grammar-token-python-grammar-subscription)
**augop**: "+=" | "-=" | "*=" | "=" | "/=" | "//=" | "%=" | "**="
| ">>=" | "<<=" | "&=" | "^=" | "|="
...
### 7.2.2. Annotated assignment statements[¶](#annotated-assignment-statements)

[Annotation](../glossary.html#term-variable-annotation) assignment is the combination, in a single
statement, of a variable or attribute annotation and an optional assignment statement:

```

**annotated_assignment_stmt**: [`augtarget`](#grammar-token-python-grammar-augtarget) ":" [`expression`](expressions.html#grammar-token-python-grammar-expression)
["=" ([`starred_expression`](expressions.html#grammar-token-python-grammar-starred_expression) | [`yield_expression`](expressions.html#grammar-token-python-grammar-yield_expression))]
...
[annotation scope](executionmodel.html#annotation-scopes). The annotations can be
evaluated using the [`__annotations__`](datamodel.html#object.__annotations__) attribute of a
class or module, or using the facilities in the [`annotationlib`](../library/annotationlib.html#module-annotationlib)
module.
...
[`__setitem__()`](datamodel.html#object.__setitem__) or [`__setattr__()`](datamodel.html#object.__setattr__) call.
...
The proposal that added the [`typing`](../library/typing.html#module-typing) module to provide a standard
...
Changed in version 3.14: Annotations are now lazily evaluated in a separate [annotation scope](executionmodel.html#annotation-scopes).
If the assignment target is not simple, annotations are never evaluated.

## 7.3. The `assert` statement[¶](#the-assert-statement)
...
**assert_stmt**: "assert" [`expression`](expressions.html#grammar-token-python-grammar-expression) ["," [`expression`](expressions.html#grammar-token-python-grammar-expression)]
...
These equivalences assume that [`__debug__`](../library/constants.html#debug__) and [`AssertionError`](../library/exceptions.html#AssertionError) refer to
...
Assignments to [`__debug__`](../library/constants.html#debug__) are illegal. The value for the built-in variable
is determined when the interpreter starts.

## 7.4. The `pass` statement[¶](#the-pass-statement)
...
## 7.5. The `del` statement[¶](#the-del-statement)

```

**del_stmt**: "del" [`target_list`](#grammar-token-python-grammar-target_list)
...
[`NameError`](../library/exceptions.html#NameError) exception.
...
## 7.6. The `return` statement[¶](#the-return-statement)
...
generator is done and will cause [`StopIteration`](../library/exceptions.html#StopIteration) to be raised. The returned
value (if any) is used as an argument to construct `StopIteration` and
becomes the [`StopIteration.value`](../library/exceptions.html#StopIteration.value) attribute.

In an asynchronous generator function, an empty [`return`](#return) statement
indicates that the asynchronous generator is done and will cause
[`StopAsyncIteration`](../library/exceptions.html#StopAsyncIteration) to be raised. A non-empty `return`
statement is a syntax error in an asynchronous generator function.

## 7.7. The `yield` statement[¶](#the-yield-statement)

```

**yield_stmt**: [`yield_expression`](expressions.html#grammar-token-python-grammar-yield_expression)
...
## 7.8. The `raise` statement[¶](#the-raise-statement)
...
If there isn’t currently an active exception, a [`RuntimeError`](../library/exceptions.html#RuntimeError) exception is raised
indicating that this is an error.

Otherwise, [`raise`](#raise) evaluates the first expression as the exception
object. It must be either a subclass or an instance of [`BaseException`](../library/exceptions.html#BaseException).
...
and attached to it as the [`__traceback__`](../library/exceptions.html#BaseException.__traceback__) attribute.
You can create an exception and set your own traceback in one step using the
[`with_traceback()`](../library/exceptions.html#BaseException.with_traceback) exception method (which returns the
...
exception as the [`__cause__`](../library/exceptions.html#BaseException.__cause__) attribute (which is writable). If the
...
attached as the new exception’s [`__context__`](../library/exceptions.html#BaseException.__context__) attribute:
...
Exception chaining can be explicitly suppressed by specifying [`None`](../library/constants.html#None) in
the `from` clause:
...
Changed in version 3.3: [`None`](../library/constants.html#None) is now permitted as `Y` in `raise X from Y`.

Added the [`__suppress_context__`](../library/exceptions.html#BaseException.__suppress_context__) attribute to suppress
...
## 7.9. The `break` statement[¶](#the-break-statement)
...
## 7.10. The `continue` statement[¶](#the-continue-statement)
...
## 7.11. The `import` statement[¶](#the-import-statement)

```

**import_stmt**: "import" [`module`](#grammar-token-python-grammar-module) ["as" [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier)] ("," [`module`](#grammar-token-python-grammar-module) ["as" [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier)])*
| "from" [`relative_module`](#grammar-token-python-grammar-relative_module) "import" [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier) ["as" [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier)]
("," [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier) ["as" [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier)])*
| "from" [`relative_module`](#grammar-token-python-grammar-relative_module) "import" "(" [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier) ["as" [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier)]
("," [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier) ["as" [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier)])* [","] ")"
| "from" [`relative_module`](#grammar-token-python-grammar-relative_module) "import" "*"
**module**: ([`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier) ".")* [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier)
**relative_module**: "."* [`module`](#grammar-token-python-grammar-module) | "."+
...
* find the module specified in the [`from`](#from) clause, loading and
initializing it if necessary;

* for each of the identifiers specified in the [`import`](#import) clauses:
...
* if the attribute is not found, [`ImportError`](../library/exceptions.html#ImportError) is raised.
...
NFKC; see [Non-ASCII characters in names](lexical_analysis.html#lexical-names-nonascii) for details. The names
...
raise a [`SyntaxError`](../library/exceptions.html#SyntaxError).
...
[`importlib.import_module()`](../library/importlib.html#importlib.import_module) is provided to support applications that
...
### 7.11.1. Future statements[¶](#future-statements)
...
**future_stmt**: "from" "__future__" "import" [`feature`](#grammar-token-python-grammar-feature) ["as" [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier)]
("," [`feature`](#grammar-token-python-grammar-feature) ["as" [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier)])*
| "from" "__future__" "import" "(" [`feature`](#grammar-token-python-grammar-feature) ["as" [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier)]
("," [`feature`](#grammar-token-python-grammar-feature) ["as" [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier)])* [","] ")"
**feature**: [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier)
...
a standard module [`__future__`](../library/__future__.html#module-__future__), described later, and it will be imported in
...
Code compiled by calls to the built-in functions [`exec()`](../library/functions.html#exec) and [`compile()`](../library/functions.html#compile)
...
## 7.12. The `global` statement[¶](#the-global-statement)

```

**global_stmt**: "global" [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier) ("," [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier))*
...
A [`SyntaxError`](../library/exceptions.html#SyntaxError) is raised if a variable is used or
...
This requirement is relaxed in the interactive prompt ([REPL](../glossary.html#term-REPL)).
...
object supplied to the built-in [`exec()`](../library/functions.html#exec) function does not affect the code
...
call. The same applies to the [`eval()`](../library/functions.html#eval) and [`compile()`](../library/functions.html#compile) functions.

## 7.13. The `nonlocal` statement[¶](#the-nonlocal-statement)

```

**nonlocal_stmt**: "nonlocal" [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier) ("," [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier))*
...
or if there is no nonlocal scope, a [`SyntaxError`](../library/exceptions.html#SyntaxError) is raised.

The [`nonlocal`](#nonlocal) statement applies to the entire scope of a function or
class body. A [`SyntaxError`](../library/exceptions.html#SyntaxError) is raised if a variable is used or
...
## 7.14. The `type` statement[¶](#the-type-statement)

```

**type_stmt**: 'type' [`identifier`](lexical_analysis.html#grammar-token-python-grammar-identifier) [[`type_params`](compound_stmts.html#grammar-token-python-grammar-type_params)] "=" [`expression`](expressions.html#grammar-token-python-grammar-expression)

```

The `type` statement declares a type alias, which is an instance
of [`typing.TypeAliasType`](../library/typing.html#typing.TypeAliasType).
...
*
[Show source
](https://github.com/python/cpython/blob/main/Doc/reference/simple_stmts.rst?plain=1)
