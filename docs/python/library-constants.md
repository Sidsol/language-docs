---
sourceUrl: https://docs.python.org/3/library/constants.html
...
assignment to  `...` raises a `SyntaxError`.
...
interpreter or called as functions, raise `SystemExit` with the
specified exit code.
