...
## 3.1. Objects, values and types[¶](#objects-values-and-types)
...
[`id()`](../library/functions.html#id) function returns an integer representing its identity.

**CPython implementation detail:** For CPython, `id(x)` is the memory address where `x` is stored.

An object’s type determines the operations that the object supports (e.g., “does
it have a length?”) and also defines the possible values for objects of that
type. The [`type()`](../library/functions.html#type) function returns an object’s type (which is an object
...
containing circular references. See the documentation of the [`gc`](../library/gc.html#module-gc)
...
This is because [`int`](../library/functions.html#int) is an immutable type, so the reference to `1`
...
## 3.2. The standard type hierarchy[¶](#the-standard-type-hierarchy)
...
### 3.2.2. NotImplemented[¶](#notimplemented)

This type has a single value. There is a single object with this value. This
object is accessed through the built-in name [`NotImplemented`](../library/constants.html#NotImplemented). Numeric methods
...
Changed in version 3.9: Evaluating [`NotImplemented`](../library/constants.html#NotImplemented) in a boolean context was deprecated.

Changed in version 3.14: Evaluating [`NotImplemented`](../library/constants.html#NotImplemented) in a boolean context now raises a [`TypeError`](../library/exceptions.html#TypeError).
It previously evaluated to [`True`](../library/constants.html#True) and emitted a [`DeprecationWarning`](../library/exceptions.html#DeprecationWarning)
since Python 3.9.

### 3.2.3. Ellipsis[¶](#ellipsis)

This type has a single value. There is a single object with this value. This
object is accessed through the literal `...` or the built-in name
`Ellipsis`. Its truth value is true.

### 3.2.4. [`numbers.Number`](../library/numbers.html#numbers.Number)[¶](#numbers-number)
...
#### 3.2.4.1. [`numbers.Integral`](../library/numbers.html#numbers.Integral)[¶](#numbers-integral)
...
**Integers ([`int`](../library/functions.html#int))**
...
**Booleans ([`bool`](../library/functions.html#bool))**
...
#### 3.2.4.2. [`numbers.Real`](../library/numbers.html#numbers.Real) ([`float`](../library/functions.html#float))[¶](#numbers-real-float)
...
#### 3.2.4.3. [`numbers.Complex`](../library/numbers.html#numbers.Complex) ([`complex`](../library/functions.html#complex))[¶](#numbers-complex-complex)
...
### 3.2.5. Sequences[¶](#sequences)

These represent finite ordered sets indexed by non-negative numbers. The
built-in function [`len()`](../library/functions.html#len) returns the number of items of a sequence. When
...
in the sequence. If it is not, an [`IndexError`](../library/exceptions.html#IndexError) is raised.
...
If *start* is missing or [`None`](../library/constants.html#None), slicing behaves as if *start* was zero.
...
#### 3.2.5.1. Immutable sequences[¶](#immutable-sequences)
...
**Strings**
A string ([`str`](../library/stdtypes.html#str)) is a sequence of values that represent
...
The built-in function [`ord()`](../library/functions.html#ord)
converts a code point from its string form to an integer in the
range `0` to `0x10FFFF`; [`chr()`](../library/functions.html#chr) converts an integer in the range
`0` to `0x10FFFF` to the corresponding length `1` string object.
[`str.encode()`](../library/stdtypes.html#str.encode) can be used to convert a [`str`](../library/stdtypes.html#str) to
[`bytes`](../library/stdtypes.html#bytes) using the given text encoding, and
[`bytes.decode()`](../library/stdtypes.html#bytes.decode) can be used to achieve the opposite.

**Tuples**
The items of a [`tuple`](../library/stdtypes.html#tuple) are arbitrary Python objects. Tuples of two or
...
**Bytes**
A [`bytes`](../library/stdtypes.html#bytes) object is an immutable array. The items are 8-bit bytes,
represented by integers in the range 0 <= x < 256. Bytes literals
(like `b'abc'`) and the built-in [`bytes()`](../library/stdtypes.html#bytes) constructor
can be used to create bytes objects. Also, bytes objects can be
decoded to strings via the [`decode()`](../library/stdtypes.html#bytes.decode) method.

#### 3.2.5.2. Mutable sequences[¶](#mutable-sequences)
...
The [`collections`](../library/collections.html#module-collections) and [`array`](../library/array.html#module-array) module provide
...
[`bytearray()`](../library/stdtypes.html#bytearray) constructor. Aside from being mutable
(and hence unhashable), byte arrays otherwise provide the same interface
and functionality as immutable [`bytes`](../library/stdtypes.html#bytes) objects.

### 3.2.6. Set types[¶](#set-types)

These represent unordered, finite sets of unique, immutable objects. As such,
they cannot be indexed by any subscript. However, they can be iterated over, and
the built-in function [`len()`](../library/functions.html#len) returns the number of items in a set. Common
...
**Sets**
These represent a mutable set. They are created by the built-in [`set()`](../library/stdtypes.html#set)
constructor and can be modified afterwards by several methods, such as
[`add()`](../library/stdtypes.html#set.add).

**Frozen sets**
These represent an immutable set. They are created by the built-in
[`frozenset()`](../library/stdtypes.html#frozenset) constructor. As a frozenset is immutable and
[hashable](../glossary.html#term-hashable), it can be used again as an element of another set, or as
a dictionary key.

### 3.2.7. Mappings[¶](#mappings)

These represent finite sets of objects indexed by arbitrary index sets. The
subscript notation `a[k]` selects the item indexed by `k` from the mapping
`a`; this can be used in expressions and as the target of assignments or
[`del`](simple_stmts.html#del) statements. The built-in function [`len()`](../library/functions.html#len) returns the number
of items in a mapping.

There is currently a single intrinsic mapping type:

#### 3.2.7.1. Dictionaries[¶](#dictionaries)
...
The extension modules [`dbm.ndbm`](../library/dbm.html#module-dbm.ndbm) and [`dbm.gnu`](../library/dbm.html#module-dbm.gnu) provide
additional examples of mapping types, as does the [`collections`](../library/collections.html#module-collections)
module.
...
### 3.2.8. Callable types[¶](#callable-types)

These are the types to which the function call operation (see section
[Calls](expressions.html#calls)) can be applied:

#### 3.2.8.1. User-defined functions[¶](#user-defined-functions)
...
##### 3.2.8.1.1. Special read-only attributes[¶](#special-read-only-attributes)
...
**
function.__builtins__[¶](#function.__builtins__)**

A reference to the [`dictionary`](../library/stdtypes.html#dict) that holds the function’s
builtins namespace.

Added in version 3.10.

**
function.__globals__[¶](#function.__globals__)**

A reference to the [`dictionary`](../library/stdtypes.html#dict) that holds the function’s
[global variables](executionmodel.html#naming) – the global namespace of the module
in which the function was defined.

**
function.__closure__[¶](#function.__closure__)**

`None` or a [`tuple`](../library/stdtypes.html#tuple) of cells that contain bindings for the names specified
in the [`co_freevars`](#codeobject.co_freevars) attribute of the function’s
[`code object`](#function.__code__).

A cell object has the attribute `cell_contents`.
This can be used to get the value of the cell, as well as set the value.

##### 3.2.8.1.2. Special writable attributes[¶](#special-writable-attributes)
...
The function’s name.
See also: [`__name__ attributes`](../library/stdtypes.html#definition.__name__).

**
function.__qualname__[¶](#function.__qualname__)**

The function’s [qualified name](../glossary.html#term-qualified-name).
See also: [`__qualname__ attributes`](../library/stdtypes.html#definition.__qualname__).
...
**
function.__defaults__[¶](#function.__defaults__)**

A [`tuple`](../library/stdtypes.html#tuple) containing default [parameter](../glossary.html#term-parameter) values
...
The [code object](#code-objects) representing
...
See also: [`__dict__ attributes`](#object.__dict__).

**
function.__annotations__[¶](#function.__annotations__)**

A [`dictionary`](../library/stdtypes.html#dict) containing annotations of
[parameters](../glossary.html#term-parameter).
The keys of the dictionary are the parameter names,
and `'return'` for the return annotation, if provided.
See also: [`object.__annotations__`](#object.__annotations__).

Changed in version 3.14: Annotations are now [lazily evaluated](executionmodel.html#lazy-evaluation).
See [**PEP 649**](https://peps.python.org/pep-0649/).

**
function.__annotate__[¶](#function.__annotate__)**

The [annotate function](../glossary.html#term-annotate-function) for this function, or `None`
if the function has no annotations. See [`object.__annotate__`](#object.__annotate__).

Added in version 3.14.

**
function.__kwdefaults__[¶](#function.__kwdefaults__)**

A [`dictionary`](../library/stdtypes.html#dict) containing defaults for keyword-only
[parameters](../glossary.html#term-parameter).

**
function.__type_params__[¶](#function.__type_params__)**

A [`tuple`](../library/stdtypes.html#tuple) containing the [type parameters](compound_stmts.html#type-params) of
a [generic function](compound_stmts.html#generic-functions).
...
#### 3.2.8.2. Instance methods[¶](#instance-methods)
...
**
method.__func__[¶](#method.__func__)**

Refers to the original [function object](#user-defined-funcs)

**
method.__doc__[¶](#method.__doc__)**

The method’s documentation
(same as [`method.__func__.__doc__`](#function.__doc__)).
A [`string`](../library/stdtypes.html#str) if the original function had a docstring, else
`None`.
...
(same as [`method.__func__.__name__`](#function.__name__))
...
[`classmethod`](../library/functions.html#classmethod) object.
...
When an instance method object is created by retrieving a [`classmethod`](../library/functions.html#classmethod)
...
When an instance method object is derived from a [`classmethod`](../library/functions.html#classmethod) object, the
...
#### 3.2.8.3. Generator functions[¶](#generator-functions)
...
[`iterator.__next__()`](../library/stdtypes.html#iterator.__next__) method will cause the function to execute until
...
[`StopIteration`](../library/exceptions.html#StopIteration) exception is raised and the iterator will have
reached the end of the set of values to be returned.

#### 3.2.8.4. Coroutine functions[¶](#coroutine-functions)

A function or method which is defined using [`async def`](compound_stmts.html#async-def) is called
a *coroutine function*. Such a function, when called, returns a
[coroutine](../glossary.html#term-coroutine) object. It may contain [`await`](expressions.html#await) expressions,
as well as [`async with`](compound_stmts.html#async-with) and [`async for`](compound_stmts.html#async-for) statements. See
also the [Coroutine Objects](#coroutine-objects) section.

#### 3.2.8.5. Asynchronous generator functions[¶](#asynchronous-generator-functions)
...
statement or falls off the end, a [`StopAsyncIteration`](../library/exceptions.html#StopAsyncIteration) exception
is raised and the asynchronous iterator will have reached the end of
the set of values to be yielded.

#### 3.2.8.6. Built-in functions[¶](#built-in-functions)

A built-in function object is a wrapper around a C function. Examples of
built-in functions are [`len()`](../library/functions.html#len) and [`math.sin()`](../library/math.html#math.sin) ([`math`](../library/math.html#module-math) is a
...
#### 3.2.8.7. Built-in methods[¶](#built-in-methods)
...
#### 3.2.8.9. Class Instances[¶](#class-instances)

Instances of arbitrary classes can be made callable by defining a
[`__call__()`](#object.__call__) method in their class.

### 3.2.9. Modules[¶](#modules)
...
functions such as [`importlib.import_module()`](../library/importlib.html#importlib.import_module) and built-in
[`__import__()`](../library/functions.html#import__). A module object has a namespace implemented by a
[`dictionary`](../library/stdtypes.html#dict) object (this is the dictionary referenced by the
...
#### 3.2.9.1. Import-related attributes on module objects[¶](#import-related-attributes-on-module-objects)

Module objects have the following attributes that relate to the
[import system](import.html#importsystem). When a module is created using the machinery associated
with the import system, these attributes are filled in based on the module’s
[spec](../glossary.html#term-module-spec), before the [loader](../glossary.html#term-loader) executes and loads the
module.

To create a module dynamically rather than using the import system,
it’s recommended to use [`importlib.util.module_from_spec()`](../library/importlib.html#importlib.util.module_from_spec),
which will set the various import-controlled attributes to appropriate values.
It’s also possible to use the [`types.ModuleType`](../library/types.html#types.ModuleType) constructor to create
...
With the exception of [`__name__`](#module.__name__), it is **strongly**
recommended that you rely on [`__spec__`](#module.__spec__) and its attributes
...
[`module.__spec__.name`](../library/importlib.html#importlib.machinery.ModuleSpec.name).
...
Set to the [`module spec`](../library/importlib.html#importlib.machinery.ModuleSpec) that was
used when importing the module. See [Module specs](import.html#module-specs) for more details.
...
The [package](../glossary.html#term-package) a module belongs to.
...
modules created dynamically using the [`types.ModuleType`](../library/types.html#types.ModuleType) constructor;
use [`importlib.util.module_from_spec()`](../library/importlib.html#importlib.util.module_from_spec) instead to ensure the attribute
is set to a [`str`](../library/stdtypes.html#str).

It is **strongly** recommended that you use
[`module.__spec__.parent`](../library/importlib.html#importlib.machinery.ModuleSpec.parent)
...
using the [`types.ModuleType`](../library/types.html#types.ModuleType) constructor.
Previously the attribute was optional.

Changed in version 3.6: The value of `__package__` is expected to be the same as
[`__spec__.parent`](../library/importlib.html#importlib.machinery.ModuleSpec.parent).
[`__package__`](#module.__package__) is now only used as a fallback during import
resolution if `__spec__.parent` is not defined.

Changed in version 3.10: [`ImportWarning`](../library/exceptions.html#ImportWarning) is raised if an import resolution falls back to
`__package__` instead of
[`__spec__.parent`](../library/importlib.html#importlib.machinery.ModuleSpec.parent).

Changed in version 3.12: Raise [`DeprecationWarning`](../library/exceptions.html#DeprecationWarning) instead of [`ImportWarning`](../library/exceptions.html#ImportWarning) when
falling back to `__package__` during import resolution.

Deprecated since version 3.13, will be removed in version 3.15: `__package__` will cease to be set or taken into consideration
by the import system or standard library.

**
module.__loader__[¶](#module.__loader__)**

The [loader](../glossary.html#term-loader) object that the import machinery used to load the module.
...
using the [`types.ModuleType`](../library/types.html#types.ModuleType) constructor;
use [`importlib.util.module_from_spec()`](../library/importlib.html#importlib.util.module_from_spec) instead to ensure the attribute
is set to a [loader](../glossary.html#term-loader) object.

It is **strongly** recommended that you use
[`module.__spec__.loader`](../library/importlib.html#importlib.machinery.ModuleSpec.loader)
...
A (possibly empty) [sequence](../glossary.html#term-sequence) of strings enumerating the locations
where the package’s submodules will be found. Non-package modules should
not have a `__path__` attribute. See [__path__ attributes on modules](import.html#package-path-rules) for
more details.

It is **strongly** recommended that you use
[`module.__spec__.submodule_search_locations`](../library/importlib.html#importlib.machinery.ModuleSpec.submodule_search_locations)
...
**
module.__cached__[¶](#module.__cached__)**

`__file__` and `__cached__` are both optional attributes that
may or may not be set. Both attributes should be a [`str`](../library/stdtypes.html#str) when they
are available.
...
[import system](import.html#importsystem) may opt to leave it unset if it
has no semantic meaning (for example, a module loaded from a database).

If `__file__` is set then the `__cached__` attribute might
...
compiled file *would* exist (see [**PEP 3147**](https://peps.python.org/pep-3147/)).

Note that `__cached__` may be set even if `__file__` is not
set. However, that scenario is quite atypical. Ultimately, the
[loader](../glossary.html#term-loader) is what makes use of the module spec provided by the
[finder](../glossary.html#term-finder) (from which `__file__` and `__cached__` are
...
It is **strongly** recommended that you use
[`module.__spec__.cached`](../library/importlib.html#importlib.machinery.ModuleSpec.cached)
instead of `module.__cached__`.

Deprecated since version 3.13, will be removed in version 3.15: Setting `__cached__` on a module while failing to set
`__spec__.cached` is deprecated. In Python 3.15,
`__cached__` will cease to be set or taken into consideration by
the import system or standard library.

#### 3.2.9.2. Other writable attributes on module objects[¶](#other-writable-attributes-on-module-objects)

As well as the import-related attributes listed above, module objects also have
the following writable attributes:

**
module.__doc__[¶](#module.__doc__)**

The module’s documentation string, or `None` if unavailable.
See also: [`__doc__ attributes`](../library/stdtypes.html#definition.__doc__).

**
module.__annotations__[¶](#module.__annotations__)**

A dictionary containing [variable annotations](../glossary.html#term-variable-annotation)
collected during module body execution. For best practices on working with
`__annotations__`, see [`annotationlib`](../library/annotationlib.html#module-annotationlib).

Changed in version 3.14: Annotations are now [lazily evaluated](executionmodel.html#lazy-evaluation).
See [**PEP 649**](https://peps.python.org/pep-0649/).

**
module.__annotate__[¶](#module.__annotate__)**

The [annotate function](../glossary.html#term-annotate-function) for this module, or `None` if the module has
no annotations. See also: [`__annotate__`](#object.__annotate__) attributes.

Added in version 3.14.

#### 3.2.9.3. Module dictionaries[¶](#module-dictionaries)
...
### 3.2.10. Custom classes[¶](#custom-classes)
...
When it would yield a [`staticmethod`](../library/functions.html#staticmethod) object,
...
#### 3.2.10.1. Special attributes[¶](#special-attributes)
...
**
type.__qualname__[¶](#type.__qualname__)**

The class’s [qualified name](../glossary.html#term-qualified-name).
See also: [`__qualname__ attributes`](../library/stdtypes.html#definition.__qualname__).

**
type.__module__[¶](#type.__module__)**

The name of the module in which the class was defined.

**
type.__dict__[¶](#type.__dict__)**

A [`mapping proxy`](../library/types.html#types.MappingProxyType)
...
[`tp_base`](../c-api/typeobj.html#c.PyTypeObject.tp_base) at the C level.
...
**
type.__annotations__[¶](#type.__annotations__)**

A dictionary containing
[variable annotations](../glossary.html#term-variable-annotation)
collected during class body execution. See also:
[`__annotations__ attributes`](#object.__annotations__).

For best practices on working with [`__annotations__`](#object.__annotations__),
please see [`annotationlib`](../library/annotationlib.html#module-annotationlib). Use
[`annotationlib.get_annotations()`](../library/annotationlib.html#annotationlib.get_annotations) instead of accessing this
attribute directly.
...
See [**749**](https://peps.python.org/pep-0749/#pep749-metaclasses) for details.
...
**
type.__annotate__()[¶](#type.__annotate__)**

The [annotate function](../glossary.html#term-annotate-function) for this class, or `None`
if the class has no annotations.
See also: [`__annotate__ attributes`](#object.__annotate__).

Added in version 3.14.

**
type.__type_params__[¶](#type.__type_params__)**

A [`tuple`](../library/stdtypes.html#tuple) containing the [type parameters](compound_stmts.html#type-params) of
a [generic class](compound_stmts.html#generic-classes).

Added in version 3.12.

**
type.__static_attributes__[¶](#type.__static_attributes__)**

A [`tuple`](../library/stdtypes.html#tuple) containing names of attributes of this class which are
assigned through `self.X` from any function in its body.

Added in version 3.13.

**
type.__firstlineno__[¶](#type.__firstlineno__)**

The line number of the first line of the class definition,
including decorators.
Setting the [`__module__`](#type.__module__) attribute removes the
`__firstlineno__` item from the type’s dictionary.

Added in version 3.13.

**
type.__mro__[¶](#type.__mro__)**

The [`tuple`](../library/stdtypes.html#tuple) of classes that are considered when looking for
base classes during method resolution.

#### 3.2.10.2. Special methods[¶](#special-methods)
...
#### 3.2.11.1. Special attributes[¶](#id5)
...
section on [__slots__](#slots) for more details.

### 3.2.12. I/O objects (also known as file objects)[¶](#i-o-objects-also-known-as-file-objects)

A [file object](../glossary.html#term-file-object) represents an open file. Various shortcuts are
available to create file objects: the [`open()`](../library/functions.html#open) built-in function, and
also [`os.popen()`](../library/os.html#os.popen), [`os.fdopen()`](../library/os.html#os.fdopen), and the
[`makefile()`](../library/socket.html#socket.socket.makefile) method of socket objects (and perhaps by
...
therefore follow the interface defined by the [`io.TextIOBase`](../library/io.html#io.TextIOBase)
abstract class.

**
file.read(*size=-1*, */*)[¶](#file.read)**
...
##### 3.2.13.1.1. Special read-only attributes[¶](#index-64)

**
codeobject.co_name[¶](#codeobject.co_name)**

The function name

**
codeobject.co_qualname[¶](#codeobject.co_qualname)**
...
**
codeobject.co_argcount[¶](#codeobject.co_argcount)**

The total number of positional [parameters](../glossary.html#term-parameter)
(including positional-only parameters and parameters with default values)
that the function has

**
codeobject.co_posonlyargcount[¶](#codeobject.co_posonlyargcount)**

The number of positional-only [parameters](../glossary.html#term-parameter)
(including arguments with default values) that the function has

**
codeobject.co_kwonlyargcount[¶](#codeobject.co_kwonlyargcount)**

The number of keyword-only [parameters](../glossary.html#term-parameter)
(including arguments with default values) that the function has

**
codeobject.co_nlocals[¶](#codeobject.co_nlocals)**

The number of [local variables](executionmodel.html#naming) used by the function
(including parameters)

**
codeobject.co_varnames[¶](#codeobject.co_varnames)**

A [`tuple`](../library/stdtypes.html#tuple) containing the names of the local variables in the
function (starting with the parameter names)

**
codeobject.co_cellvars[¶](#codeobject.co_cellvars)**

A [`tuple`](../library/stdtypes.html#tuple) containing the names of [local variables](executionmodel.html#naming)
that are referenced from at least one [nested scope](../glossary.html#term-nested-scope) inside the function

**
codeobject.co_freevars[¶](#codeobject.co_freevars)**

A [`tuple`](../library/stdtypes.html#tuple) containing the names of
[free (closure) variables](../glossary.html#term-closure-variable) that a [nested scope](../glossary.html#term-nested-scope)
references in an outer scope. See also [`function.__closure__`](#function.__closure__).

Note: references to global and builtin names are *not* included.

**
codeobject.co_code[¶](#codeobject.co_code)**

A string representing the sequence of [bytecode](../glossary.html#term-bytecode) instructions in
the function

**
codeobject.co_consts[¶](#codeobject.co_consts)**

A [`tuple`](../library/stdtypes.html#tuple) containing the literals used by the [bytecode](../glossary.html#term-bytecode) in
the function

**
codeobject.co_names[¶](#codeobject.co_names)**

A [`tuple`](../library/stdtypes.html#tuple) containing the names used by the [bytecode](../glossary.html#term-bytecode) in
the function

**
codeobject.co_filename[¶](#codeobject.co_filename)**

The name of the file from which the code was compiled

**
codeobject.co_firstlineno[¶](#codeobject.co_firstlineno)**

The line number of the first line of the function

**
codeobject.co_lnotab[¶](#codeobject.co_lnotab)**

A string encoding the mapping from [bytecode](../glossary.html#term-bytecode) offsets to line
...
**
codeobject.co_stacksize[¶](#codeobject.co_stacksize)**

The required stack size of the code object

**
codeobject.co_flags[¶](#codeobject.co_flags)**

An [`integer`](../library/functions.html#int) encoding a number of flags for the
interpreter.
...
particular feature enabled. See [`compiler_flag`](../library/__future__.html#future__._Feature.compiler_flag).

Other bits in [`co_flags`](#codeobject.co_flags) are reserved for internal use.

If a code object represents a function and has a docstring,
the [`CO_HAS_DOCSTRING`](../library/inspect.html#inspect.CO_HAS_DOCSTRING) bit is set in [`co_flags`](#codeobject.co_flags)
and the first item in [`co_consts`](#codeobject.co_consts) is
the docstring of the function.

##### 3.2.13.1.2. Methods on code objects[¶](#methods-on-code-objects)

**
codeobject.co_positions()[¶](#codeobject.co_positions)**

Returns an iterable over the source code positions of each [bytecode](../glossary.html#term-bytecode)
instruction in the code object.

The iterator returns [`tuple`](../library/stdtypes.html#tuple)s containing the `(start_line, end_line,
...
**
codeobject.co_lines()[¶](#codeobject.co_lines)**
...
* `start` (an [`int`](../library/functions.html#int)) represents the offset (inclusive) of the start
of the [bytecode](../glossary.html#term-bytecode) range

* `end` (an [`int`](../library/functions.html#int)) represents the offset (exclusive) of the end of
the [bytecode](../glossary.html#term-bytecode) range

* `lineno` is an [`int`](../library/functions.html#int) representing the line number of the
...
is, for any pair of [`tuple`](../library/stdtypes.html#tuple)s, the `start` of the second will be
equal to the `end` of the first.

* No range will be backwards: `end >= start` for all triples.

* The last [`tuple`](../library/stdtypes.html#tuple) yielded will have `end` equal to the size of the
...
**
codeobject.replace(***kwargs*)[¶](#codeobject.replace)**

Return a copy of the code object with new values for the specified fields.

Code objects are also supported by the generic function [`copy.replace()`](../library/copy.html#copy.replace).

Added in version 3.8.

#### 3.2.13.2. Frame objects[¶](#frame-objects)

Frame objects represent execution frames. They may occur in
[traceback objects](#traceback-objects),
and are also passed to registered trace functions.

##### 3.2.13.2.1. Special read-only attributes[¶](#index-70)

**
frame.f_back[¶](#frame.f_back)**
...
The [code object](#code-objects) being executed in this frame.
Accessing this attribute raises an [auditing event](../library/sys.html#auditing)
...
[local variables](executionmodel.html#naming).
If the frame refers to an [optimized scope](../glossary.html#term-optimized-scope),
...
[global variables](executionmodel.html#naming)

**
frame.f_builtins[¶](#frame.f_builtins)**

The dictionary used by the frame to look up
[built-in (intrinsic) names](executionmodel.html#naming)

**
frame.f_lasti[¶](#frame.f_lasti)**

The “precise instruction” of the frame object
(this is an index into the [bytecode](../glossary.html#term-bytecode) string of the
[code object](#code-objects))

**
frame.f_generator[¶](#frame.f_generator)**

The [generator](../glossary.html#term-generator) or [coroutine](../glossary.html#term-coroutine) object that owns this frame,
or `None` if the frame is a normal function.

Added in version 3.14.

##### 3.2.13.2.2. Special writable attributes[¶](#index-71)

**
frame.f_trace[¶](#frame.f_trace)**
...
triggered for each new source line (see [`f_trace_lines`](#frame.f_trace_lines)).

**
frame.f_trace_lines[¶](#frame.f_trace_lines)**

Set this attribute to [`False`](../library/constants.html#False) to disable triggering a tracing
event for each source line.

**
frame.f_trace_opcodes[¶](#frame.f_trace_opcodes)**

Set this attribute to [`True`](../library/constants.html#True) to allow per-opcode events to be
...
##### 3.2.13.2.3. Frame object methods[¶](#frame-object-methods)
...
[`RuntimeError`](../library/exceptions.html#RuntimeError) is raised if the frame is currently executing
or suspended.

Added in version 3.4.

Changed in version 3.13: Attempting to clear a suspended frame raises [`RuntimeError`](../library/exceptions.html#RuntimeError)
(as has always been the case for executing frames).

#### 3.2.13.3. Traceback objects[¶](#traceback-objects)

Traceback objects represent the stack trace of an [exception](../tutorial/errors.html#tut-errors).
A traceback object
is implicitly created when an exception occurs, and may also be explicitly
created by calling [`types.TracebackType`](../library/types.html#types.TracebackType).
...
tuple returned by [`sys.exc_info()`](../library/sys.html#sys.exc_info), and as the
[`__traceback__`](../library/exceptions.html#BaseException.__traceback__) attribute
of the caught exception.

When the program contains no suitable
handler, the stack trace is written (nicely formatted) to the standard error
stream; if the interpreter is interactive, it is also made available to the user
as [`sys.last_traceback`](../library/sys.html#sys.last_traceback).
...
Points to the execution [frame](#frame-objects) of the current
level.
...
**
traceback.tb_lineno[¶](#traceback.tb_lineno)**

Gives the line number where the exception occurred

**
traceback.tb_lasti[¶](#traceback.tb_lasti)**
...
**
traceback.tb_next[¶](#traceback.tb_next)**
...
#### 3.2.13.4. Slice objects[¶](#slice-objects)

Slice objects are used to represent slices for
[`__getitem__()`](#object.__getitem__)
methods. They are also created by the built-in [`slice()`](../library/functions.html#slice) function.

Special read-only attributes: [`start`](../library/functions.html#slice.start) is the lower bound;
[`stop`](../library/functions.html#slice.stop) is the upper bound; [`step`](../library/functions.html#slice.step) is the step
value; each is `None` if omitted. These attributes can have any type.

Slice objects support one method:

**
slice.indices(*self*, *length*)[¶](#slice.indices)**
...
#### 3.2.13.5. Static method objects[¶](#static-method-objects)
...
objects are created by the built-in [`staticmethod()`](../library/functions.html#staticmethod) constructor.

#### 3.2.13.6. Class method objects[¶](#class-method-objects)
...
by the built-in [`classmethod()`](../library/functions.html#classmethod) constructor.

## 3.3. Special method names[¶](#special-method-names)
...
[`AttributeError`](../library/exceptions.html#AttributeError) or [`TypeError`](../library/exceptions.html#TypeError)).

Setting a special method to `None` indicates that the corresponding
operation is not available. For example, if a class sets
[`__iter__()`](#object.__iter__) to `None`, the class is not iterable, so calling
[`iter()`](../library/functions.html#iter) on its instances will raise a [`TypeError`](../library/exceptions.html#TypeError) (without
falling back to [`__getitem__()`](#object.__getitem__)). [[2]](#id21)

When implementing a class that emulates any built-in type, it is important that
the emulation only be implemented to the degree that it makes sense for the
object being modelled. For example, some sequences may work well with retrieval
of individual elements, but extracting a slice may not make sense.
(One example of this is the [NodeList](../library/xml.dom.html#dom-nodelist-objects) interface
in the W3C’s Document Object Model.)

### 3.3.1. Basic customization[¶](#basic-customization)

**
object.__new__(*cls*[, *...*])[¶](#object.__new__)**
...
**
object.__init__(*self*[, *...*])[¶](#object.__init__)**
...
Because [`__new__()`](#object.__new__) and `__init__()` work together in constructing
objects (`__new__()` to create it, and `__init__()` to customize it),
no non-`None` value may be returned by `__init__()`; doing so will
cause a [`TypeError`](../library/exceptions.html#TypeError) to be raised at runtime.

**
object.__del__(*self*)[¶](#object.__del__)**
...
[`weakref.finalize`](../library/weakref.html#weakref.finalize) provides a straightforward way to register
...
Documentation for the [`gc`](../library/gc.html#module-gc) module.
...
**
object.__repr__(*self*)[¶](#object.__repr__)**

Called by the [`repr()`](../library/functions.html#repr) built-in function to compute the “official” string
...
but not [`__str__()`](#object.__str__), then `__repr__()` is also used when an
“informal” string representation of instances of that class is required.

This is typically used for debugging, so it is important that the representation
is information-rich and unambiguous. A default implementation is provided by the
[`object`](../library/functions.html#object) class itself.

**
object.__str__(*self*)[¶](#object.__str__)**

Called by [`str(object)`](../library/stdtypes.html#str), the default [`__format__()`](#object.__format__) implementation,
and the built-in function [`print()`](../library/functions.html#print), to compute the “informal” or nicely
...
The default implementation defined by the built-in type [`object`](../library/functions.html#object)
calls [`object.__repr__()`](#object.__repr__).

**
object.__bytes__(*self*)[¶](#object.__bytes__)**

Called by [bytes](../library/functions.html#func-bytes) to compute a byte-string representation
of an object. This should return a [`bytes`](../library/stdtypes.html#bytes) object. The [`object`](../library/functions.html#object)
class itself does not provide this method.

**
object.__format__(*self*, *format_spec*)[¶](#object.__format__)**

Called by the [`format()`](../library/functions.html#format) built-in function,
and by extension, evaluation of [formatted string literals](lexical_analysis.html#f-strings) and the [`str.format()`](../library/stdtypes.html#str.format) method, to produce a “formatted”
...
The default implementation by the [`object`](../library/functions.html#object) class should be given
an empty *format_spec* string. It delegates to [`__str__()`](#object.__str__).

Changed in version 3.4: The __format__ method of `object` itself raises a [`TypeError`](../library/exceptions.html#TypeError)
...
**
object.__lt__(*self*, *other*)[¶](#object.__lt__)**

**
object.__le__(*self*, *other*)[¶](#object.__le__)**

**
object.__eq__(*self*, *other*)[¶](#object.__eq__)**

**
object.__ne__(*self*, *other*)[¶](#object.__ne__)**

**
object.__gt__(*self*, *other*)[¶](#object.__gt__)**

**
object.__ge__(*self*, *other*)[¶](#object.__ge__)**
...
A rich comparison method may return the singleton [`NotImplemented`](../library/constants.html#NotImplemented) if it does
not implement the operation for a given pair of arguments. By convention,
`False` and `True` are returned for a successful comparison. However, these
methods can return any value, so if the comparison operator is used in a Boolean
context (e.g., in the condition of an `if` statement), Python will call
[`bool()`](../library/functions.html#bool) on the value to determine if the result is true or false.

By default, `object` implements `__eq__()` by using `is`, returning
[`NotImplemented`](../library/constants.html#NotImplemented) in the case of a false comparison:
...
operations from a single root operation, see [`functools.total_ordering()`](../library/functools.html#functools.total_ordering).

By default, the [`object`](../library/functions.html#object) class provides implementations consistent
with [Value comparisons](expressions.html#expressions-value-comparisons): equality compares according to
object identity, and order comparisons raise [`TypeError`](../library/exceptions.html#TypeError). Each default
...
When no appropriate method returns any value other than [`NotImplemented`](../library/constants.html#NotImplemented), the
`==` and `!=` operators will fall back to `is` and `is not`, respectively.

**
object.__hash__(*self*)[¶](#object.__hash__)**

Called by built-in function [`hash()`](../library/functions.html#hash) and for operations on members of
hashed collections including [`set`](../library/stdtypes.html#set), [`frozenset`](../library/stdtypes.html#frozenset), and
[`dict`](../library/stdtypes.html#dict). The `__hash__()` method should return an integer. The only required
...
[`hash()`](../library/functions.html#hash) truncates the value returned from an object’s custom
`__hash__()` method to the size of a [`Py_ssize_t`](../c-api/intro.html#c.Py_ssize_t). This is
...
User-defined classes have [`__eq__()`](#object.__eq__) and `__hash__()` methods
by default (inherited from the [`object`](../library/functions.html#object) class); with them, all objects compare
...
A class that overrides [`__eq__()`](#object.__eq__) and does not define `__hash__()`
will have its `__hash__()` implicitly set to `None`. When the
`__hash__()` method of a class is `None`, instances of the class will
raise an appropriate [`TypeError`](../library/exceptions.html#TypeError) when a program attempts to retrieve
...
a [`TypeError`](../library/exceptions.html#TypeError) would be incorrectly identified as hashable by
...
**
object.__bool__(*self*)[¶](#object.__bool__)**

Called to implement truth value testing and the built-in operation
`bool()`; should return `False` or `True`. When this method is not
defined, [`__len__()`](#object.__len__) is called, if it is defined, and the object is
considered true if its result is nonzero. If a class defines neither
`__len__()` nor `__bool__()` (which is true of the [`object`](../library/functions.html#object)
class itself), all its instances are considered true.

### 3.3.2. Customizing attribute access[¶](#customizing-attribute-access)

The following methods can be defined to customize the meaning of attribute
access (use of, assignment to, or deletion of `x.name`) for class instances.

**
object.__getattr__(*self*, *name*)[¶](#object.__getattr__)**

Called when the default attribute access fails with an [`AttributeError`](../library/exceptions.html#AttributeError)
(either [`__getattribute__()`](#object.__getattribute__) raises an `AttributeError` because
...
The [`object`](../library/functions.html#object) class itself does not provide this method.

Note that if the attribute is found through the normal mechanism,
`__getattr__()` is not called. (This is an intentional asymmetry between
`__getattr__()` and [`__setattr__()`](#object.__setattr__).) This is done both for efficiency
...
**
object.__getattribute__(*self*, *name*)[¶](#object.__getattribute__)**
...
[`AttributeError`](../library/exceptions.html#AttributeError). This method should return the (computed) attribute value
...
**
object.__setattr__(*self*, *name*, *value*)[¶](#object.__setattr__)**
...
**
object.__delattr__(*self*, *name*)[¶](#object.__delattr__)**
...
**
object.__dir__(*self*)[¶](#object.__dir__)**

Called when [`dir()`](../library/functions.html#dir) is called on the object. An iterable must be
returned. `dir()` converts the returned iterable to a list and sorts it.

#### 3.3.2.1. Customizing module attribute access[¶](#customizing-module-attribute-access)

**
module.__getattr__()[¶](#module.__getattr__)**

**
module.__dir__()[¶](#module.__dir__)**

Special names `__getattr__` and `__dir__` can be also used to customize
access to module attributes. The `__getattr__` function at the module level
should accept one argument which is the name of an attribute and return the
computed value or raise an [`AttributeError`](../library/exceptions.html#AttributeError). If an attribute is
...
function overrides the standard [`dir()`](../library/functions.html#dir) search on a module.

**
module.__class__[¶](#module.__class__)**

For a more fine grained customization of the module behavior (setting
attributes, properties, etc.), one can set the `__class__` attribute of
a module object to a subclass of [`types.ModuleType`](../library/types.html#types.ModuleType). For example:
...
#### 3.3.2.2. Implementing Descriptors[¶](#implementing-descriptors)
...
class’ [`__dict__`](#object.__dict__). The [`object`](../library/functions.html#object) class itself does not
implement any of these protocols.

**
object.__get__(*self*, *instance*, *owner=None*)[¶](#object.__get__)**
...
[`AttributeError`](../library/exceptions.html#AttributeError) exception.

[**PEP 252**](https://peps.python.org/pep-0252/) specifies that `__get__()` is callable with one or two
...
**
object.__set__(*self*, *instance*, *value*)[¶](#object.__set__)**

Called to set the attribute on an instance *instance* of the owner class to a
new value, *value*.

Note, adding `__set__()` or [`__delete__()`](#object.__delete__) changes the kind of
descriptor to a “data descriptor”. See [Invoking Descriptors](#descriptor-invocation) for
more details.

**
object.__delete__(*self*, *instance*)[¶](#object.__delete__)**
...
**
object.__objclass__[¶](#object.__objclass__)**

The attribute `__objclass__` is interpreted by the [`inspect`](../library/inspect.html#module-inspect) module
...
#### 3.3.2.3. Invoking Descriptors[¶](#invoking-descriptors)
...
[`staticmethod`](../library/functions.html#staticmethod) and [`classmethod`](../library/functions.html#classmethod)) are
implemented as non-data descriptors. Accordingly, instances can redefine and
override methods. This allows individual instances to acquire behaviors that
differ from other instances of the same class.

The [`property()`](../library/functions.html#property) function is implemented as a data descriptor. Accordingly,
instances cannot override the behavior of a property.

#### 3.3.2.4. __slots__[¶](#slots)

*__slots__* allow us to explicitly declare data members (like
properties) and deny the creation of [`__dict__`](#object.__dict__) and *__weakref__*
...
variable name raises [`AttributeError`](../library/exceptions.html#AttributeError). If dynamic assignment of new
variables is desired, then add `'__dict__'` to the sequence of strings in
the *__slots__* declaration.

* Without a *__weakref__* variable for each instance, classes defining
*__slots__* do not support [`weak references`](../library/weakref.html#module-weakref) to its instances.
If weak reference
support is needed, then add `'__weakref__'` to the sequence of strings in the
*__slots__* declaration.

* *__slots__* are implemented at the class level by creating [descriptors](#descriptors)
...
[`__dict__`](#object.__dict__) and *__weakref__* unless the subclass also defines
...
* [`TypeError`](../library/exceptions.html#TypeError) will be raised if nonempty *__slots__* are defined for a
class derived from a
[`"variable-length" built-in type`](../c-api/typeobj.html#c.PyTypeObject.tp_itemsize) such as
[`int`](../library/functions.html#int), [`bytes`](../library/stdtypes.html#bytes), and [`tuple`](../library/stdtypes.html#tuple).

* Any non-string [iterable](../glossary.html#term-iterable) may be assigned to *__slots__*.

* If a [`dictionary`](../library/stdtypes.html#dict) is used to assign *__slots__*, the dictionary
...
[`inspect.getdoc()`](../library/inspect.html#inspect.getdoc) and displayed in the output of [`help()`](../library/functions.html#help).
...
* If an [iterator](../glossary.html#term-iterator) is used for *__slots__* then a [descriptor](../glossary.html#term-descriptor) is
created for each
of the iterator’s values. However, the *__slots__* attribute will be an empty
iterator.

### 3.3.3. Customizing class creation[¶](#customizing-class-creation)
...
**
*classmethod *object.__init_subclass__(*cls*)[¶](#object.__init_subclass__)**
...
**
object.__set_name__(*self*, *owner*, *name*)[¶](#object.__set_name__)**
...
#### 3.3.3.1. Metaclasses[¶](#metaclasses)

By default, classes are constructed using [`type()`](../library/functions.html#type). The class body is
...
#### 3.3.3.2. Resolving MRO entries[¶](#resolving-mro-entries)

**
object.__mro_entries__(*self*, *bases*)[¶](#object.__mro_entries__)**

If a base that appears in a class definition is not an instance of
[`type`](../library/functions.html#type), then an `__mro_entries__()` method is searched on the base.
...
**[`types.resolve_bases()`](../library/types.html#types.resolve_bases)**
Dynamically resolve bases that are not instances of [`type`](../library/functions.html#type).

**[`types.get_original_bases()`](../library/types.html#types.get_original_bases)**
...
#### 3.3.3.3. Determining the appropriate metaclass[¶](#determining-the-appropriate-metaclass)

The appropriate metaclass for a class definition is determined as follows:

* if no bases and no explicit metaclass are given, then [`type()`](../library/functions.html#type) is used;

* if an explicit metaclass is given and it is *not* an instance of
[`type()`](../library/functions.html#type), then it is used directly as the metaclass;

* if an instance of [`type()`](../library/functions.html#type) is given as the explicit metaclass, or
...
#### 3.3.3.4. Preparing the class namespace[¶](#preparing-the-class-namespace)
...
[`classmethod`](../library/functions.html#classmethod). The
...
#### 3.3.3.5. Executing the class body[¶](#executing-the-class-body)

The class body is executed (approximately) as
`exec(body, globals(), namespace)`. The key difference from a normal
call to [`exec()`](../library/functions.html#exec) is that lexical scoping allows the class body (including
...
#### 3.3.3.6. Creating the class object[¶](#creating-the-class-object)
...
form of [`super()`](../library/functions.html#super). `__class__` is an implicit closure reference
...
Failing to do so will result in a [`RuntimeError`](../library/exceptions.html#RuntimeError) in Python 3.8.

When using the default metaclass [`type`](../library/functions.html#type), or any metaclass that ultimately
...
* The [`__init_subclass__()`](#object.__init_subclass__) hook is called on the
...
#### 3.3.3.7. Uses for metaclasses[¶](#uses-for-metaclasses)
...
### 3.3.4. Customizing instance and subclass checks[¶](#customizing-instance-and-subclass-checks)

The following methods are used to override the default behavior of the
[`isinstance()`](../library/functions.html#isinstance) and [`issubclass()`](../library/functions.html#issubclass) built-in functions.

In particular, the metaclass [`abc.ABCMeta`](../library/abc.html#abc.ABCMeta) implements these methods in
order to allow the addition of Abstract Base Classes (ABCs) as “virtual base
classes” to any class or type (including built-in types), including other
ABCs.

**
type.__instancecheck__(*self*, *instance*)[¶](#type.__instancecheck__)**
...
**
type.__subclasscheck__(*self*, *subclass*)[¶](#type.__subclasscheck__)**
...
Includes the specification for customizing [`isinstance()`](../library/functions.html#isinstance) and
[`issubclass()`](../library/functions.html#issubclass) behavior through [`__instancecheck__()`](#type.__instancecheck__) and
[`__subclasscheck__()`](#type.__subclasscheck__), with motivation for this functionality
in the context of adding Abstract Base Classes (see the [`abc`](../library/abc.html#module-abc)
module) to the language.

### 3.3.5. Emulating generic types[¶](#emulating-generic-types)
...
[`list`](../library/stdtypes.html#list) in which all the elements are of type [`int`](../library/functions.html#int).
...
**[Generics](../library/typing.html#generics), [user-defined generics](../library/typing.html#user-defined-generics) and [`typing.Generic`](../library/typing.html#typing.Generic)**
...
**
*classmethod *object.__class_getitem__(*cls*, *key*)[¶](#object.__class_getitem__)**
...
[`classmethod`](../library/functions.html#classmethod) when it is defined.

#### 3.3.5.1. The purpose of *__class_getitem__*[¶](#the-purpose-of-class-getitem)
...
inherit from [`typing.Generic`](../library/typing.html#typing.Generic), which has its own implementation of
`__class_getitem__()`.
...
#### 3.3.5.2. *__class_getitem__* versus *__getitem__*[¶](#class-getitem-versus-getitem)
...
[`type`](../library/functions.html#type) class as their metaclass. `type` does not define
...
behaviour. An example of this can be found in the [`enum`](../library/enum.html#module-enum) module:
...
[subscription](expressions.html#subscriptions) results in `__class_getitem__()`
being called instead of [`__getitem__()`](#object.__getitem__)

### 3.3.6. Emulating callable objects[¶](#emulating-callable-objects)

**
object.__call__(*self*[, *args...*])[¶](#object.__call__)**

Called when the instance is “called” as a function; if this method is defined,
`x(arg1, arg2, ...)` roughly translates to `type(x).__call__(x, arg1, ...)`.
The [`object`](../library/functions.html#object) class itself does not provide this method.

### 3.3.7. Emulating container types[¶](#emulating-container-types)

The following methods can be defined to implement container objects. None of them
are provided by the [`object`](../library/functions.html#object) class itself. Containers usually are
[sequences](../glossary.html#term-sequence) (such as [`lists`](../library/stdtypes.html#list) or
[`tuples`](../library/stdtypes.html#tuple)) or [mappings](../glossary.html#term-mapping) (like
[dictionaries](../glossary.html#term-dictionary)),
but can represent other containers as well. The first set of methods is used
either to emulate a sequence or to emulate a mapping; the difference is that for
a sequence, the allowable keys should be the integers *k* for which `0 <= k <
N` where *N* is the length of the sequence, or [`slice`](../library/functions.html#slice) objects, which define a
range of items. It is also recommended that mappings provide the methods
`keys()`, `values()`, `items()`, `get()`, `clear()`,
`setdefault()`, `pop()`, `popitem()`, `copy()`, and
`update()` behaving similar to those for Python’s standard [`dictionary`](../library/stdtypes.html#dict)
objects. The [`collections.abc`](../library/collections.abc.html#module-collections.abc) module provides a
[`MutableMapping`](../library/collections.abc.html#collections.abc.MutableMapping)
...
[`append()`](../library/stdtypes.html#sequence.append), [`clear()`](../library/stdtypes.html#sequence.clear), [`count()`](../library/stdtypes.html#sequence.count),
[`extend()`](../library/stdtypes.html#sequence.extend), [`index()`](../library/stdtypes.html#sequence.index), [`insert()`](../library/stdtypes.html#sequence.insert),
[`pop()`](../library/stdtypes.html#sequence.pop), [`remove()`](../library/stdtypes.html#sequence.remove), and [`reverse()`](../library/stdtypes.html#sequence.reverse),
like Python standard [`list`](../library/stdtypes.html#list) objects.
...
**
object.__len__(*self*)[¶](#object.__len__)**

Called to implement the built-in function [`len()`](../library/functions.html#len). Should return the length
of the object, an integer `>=` 0. Also, an object that doesn’t define a
[`__bool__()`](#object.__bool__) method and whose `__len__()` method returns zero is
considered to be false in a Boolean context.

**CPython implementation detail:** In CPython, the length is required to be at most [`sys.maxsize`](../library/sys.html#sys.maxsize).
If the length is larger than `sys.maxsize` some features (such as
[`len()`](../library/functions.html#len)) may raise [`OverflowError`](../library/exceptions.html#OverflowError). To prevent raising
`OverflowError` by truth value testing, an object must define a
[`__bool__()`](#object.__bool__) method.

**
object.__length_hint__(*self*)[¶](#object.__length_hint__)**

Called to implement [`operator.length_hint()`](../library/operator.html#operator.length_hint). Should return an estimated
length for the object (which may be greater or less than the actual length).
The length must be an integer `>=` 0. The return value may also be
[`NotImplemented`](../library/constants.html#NotImplemented), which is treated the same as if the
...
**
object.__getitem__(*self*, *subscript*)[¶](#object.__getitem__)**

Called to implement *subscription*, that is, `self[subscript]`.
See [Subscriptions and slicings](expressions.html#subscriptions) for details on the syntax.

There are two types of built-in objects that support subscription
via `__getitem__()`:

* **sequences**, where *subscript* (also called
[index](../glossary.html#term-index)) should be an integer or a [`slice`](../library/functions.html#slice) object.
See the [sequence documentation](#datamodel-sequences) for the expected
behavior, including handling `slice` objects and negative indices.

* **mappings**, where *subscript* is also called the [key](../glossary.html#term-key).
See [mapping documentation](#datamodel-mappings) for the expected
behavior.

If *subscript* is of an inappropriate type, `__getitem__()`
should raise [`TypeError`](../library/exceptions.html#TypeError).
If *subscript* has an inappropriate value, `__getitem__()`
should raise an [`LookupError`](../library/exceptions.html#LookupError) or one of its subclasses
([`IndexError`](../library/exceptions.html#IndexError) for sequences; [`KeyError`](../library/exceptions.html#KeyError) for mappings).
...
The sequence iteration protocol (used, for example, in [`for`](compound_stmts.html#for)
loops), expects that an [`IndexError`](../library/exceptions.html#IndexError) will be raised for illegal
indexes to allow proper detection of the end of a sequence.

Note

When [subscripting](expressions.html#subscriptions) a *class*, the special
class method [`__class_getitem__()`](#object.__class_getitem__) may be called instead of
`__getitem__()`. See [__class_getitem__ versus __getitem__](#classgetitem-versus-getitem) for more
details.

**
object.__setitem__(*self*, *key*, *value*)[¶](#object.__setitem__)**
...
**
object.__delitem__(*self*, *key*)[¶](#object.__delitem__)**
...
**
object.__missing__(*self*, *key*)[¶](#object.__missing__)**

Called by [`dict`](../library/stdtypes.html#dict).[`__getitem__()`](#object.__getitem__) to implement `self[key]` for dict subclasses
when key is not in the dictionary.

**
object.__iter__(*self*)[¶](#object.__iter__)**
...
**
object.__reversed__(*self*)[¶](#object.__reversed__)**

Called (if present) by the [`reversed()`](../library/functions.html#reversed) built-in to implement
reverse iteration. It should return a new iterator object that iterates
over all the objects in the container in reverse order.

If the `__reversed__()` method is not provided, the [`reversed()`](../library/functions.html#reversed)
...
**
object.__contains__(*self*, *item*)[¶](#object.__contains__)**
...
### 3.3.8. Emulating numeric types[¶](#emulating-numeric-types)
...
**
object.__add__(*self*, *other*)[¶](#object.__add__)**

**
object.__sub__(*self*, *other*)[¶](#object.__sub__)**

**
object.__mul__(*self*, *other*)[¶](#object.__mul__)**

**
object.__matmul__(*self*, *other*)[¶](#object.__matmul__)**

**
object.__truediv__(*self*, *other*)[¶](#object.__truediv__)**

**
object.__floordiv__(*self*, *other*)[¶](#object.__floordiv__)**

**
object.__mod__(*self*, *other*)[¶](#object.__mod__)**

**
object.__divmod__(*self*, *other*)[¶](#object.__divmod__)**

**
object.__pow__(*self*, *other*[, *modulo*])[¶](#object.__pow__)**

**
object.__lshift__(*self*, *other*)[¶](#object.__lshift__)**

**
object.__rshift__(*self*, *other*)[¶](#object.__rshift__)**

**
object.__and__(*self*, *other*)[¶](#object.__and__)**

**
object.__xor__(*self*, *other*)[¶](#object.__xor__)**

**
object.__or__(*self*, *other*)[¶](#object.__or__)**

These methods are called to implement the binary arithmetic operations
(`+`, `-`, `*`, ``, `/`, `//`, `%`, [`divmod()`](../library/functions.html#divmod),
[`pow()`](../library/functions.html#pow), `**`, `<<`, `>>`, `&`, `^`, `|`). For instance, to
...
arguments, it should return [`NotImplemented`](../library/constants.html#NotImplemented).

**
object.__radd__(*self*, *other*)[¶](#object.__radd__)**

**
object.__rsub__(*self*, *other*)[¶](#object.__rsub__)**

**
object.__rmul__(*self*, *other*)[¶](#object.__rmul__)**

**
object.__rmatmul__(*self*, *other*)[¶](#object.__rmatmul__)**

**
object.__rtruediv__(*self*, *other*)[¶](#object.__rtruediv__)**

**
object.__rfloordiv__(*self*, *other*)[¶](#object.__rfloordiv__)**

**
object.__rmod__(*self*, *other*)[¶](#object.__rmod__)**

**
object.__rdivmod__(*self*, *other*)[¶](#object.__rdivmod__)**

**
object.__rpow__(*self*, *other*[, *modulo*])[¶](#object.__rpow__)**

**
object.__rlshift__(*self*, *other*)[¶](#object.__rlshift__)**

**
object.__rrshift__(*self*, *other*)[¶](#object.__rrshift__)**

**
object.__rand__(*self*, *other*)[¶](#object.__rand__)**

**
object.__rxor__(*self*, *other*)[¶](#object.__rxor__)**

**
object.__ror__(*self*, *other*)[¶](#object.__ror__)**

These methods are called to implement the binary arithmetic operations
(`+`, `-`, `*`, ``, `/`, `//`, `%`, [`divmod()`](../library/functions.html#divmod),
[`pow()`](../library/functions.html#pow), `**`, `<<`, `>>`, `&`, `^`, `|`) with reflected
...
operation [[3]](#id22), or the right operand’s class is derived from the left operand’s
class. [[4]](#id23) For instance, to evaluate the expression `x - y`, where *y* is
an instance of a class that has an `__rsub__()` method, `type(y).__rsub__(y, x)`
is called if `type(x).__sub__(x, y)` returns [`NotImplemented`](../library/constants.html#NotImplemented) or `type(y)`
is a subclass of `type(x)`. [[5]](#id24)

Note that `__rpow__()` should be defined to accept an optional third
argument if the three-argument version of the built-in [`pow()`](../library/functions.html#pow) function
is to be supported.

Changed in version 3.14: Three-argument [`pow()`](../library/functions.html#pow) now try calling `__rpow__()` if necessary.
...
**
object.__iadd__(*self*, *other*)[¶](#object.__iadd__)**

**
object.__isub__(*self*, *other*)[¶](#object.__isub__)**

**
object.__imul__(*self*, *other*)[¶](#object.__imul__)**

**
object.__imatmul__(*self*, *other*)[¶](#object.__imatmul__)**

**
object.__itruediv__(*self*, *other*)[¶](#object.__itruediv__)**

**
object.__ifloordiv__(*self*, *other*)[¶](#object.__ifloordiv__)**

**
object.__imod__(*self*, *other*)[¶](#object.__imod__)**

**
object.__ipow__(*self*, *other*[, *modulo*])[¶](#object.__ipow__)**

**
object.__ilshift__(*self*, *other*)[¶](#object.__ilshift__)**

**
object.__irshift__(*self*, *other*)[¶](#object.__irshift__)**

**
object.__iand__(*self*, *other*)[¶](#object.__iand__)**

**
object.__ixor__(*self*, *other*)[¶](#object.__ixor__)**

**
object.__ior__(*self*, *other*)[¶](#object.__ior__)**
...
that method returns [`NotImplemented`](../library/constants.html#NotImplemented), the
...
[Why does a_tuple[i] += [‘item’] raise an exception when the addition works?](../faq/programming.html#faq-augmented-assignment-tuple-error)), but this behavior is in fact
part of the data model.

**
object.__neg__(*self*)[¶](#object.__neg__)**

**
object.__pos__(*self*)[¶](#object.__pos__)**

**
object.__abs__(*self*)[¶](#object.__abs__)**

**
object.__invert__(*self*)[¶](#object.__invert__)**

Called to implement the unary arithmetic operations (`-`, `+`, [`abs()`](../library/functions.html#abs)
and `~`).

**
object.__complex__(*self*)[¶](#object.__complex__)**

**
object.__int__(*self*)[¶](#object.__int__)**

**
object.__float__(*self*)[¶](#object.__float__)**

Called to implement the built-in functions [`complex()`](../library/functions.html#complex),
[`int()`](../library/functions.html#int) and [`float()`](../library/functions.html#float). Should return a value
of the appropriate type.

**
object.__index__(*self*)[¶](#object.__index__)**

Called to implement [`operator.index()`](../library/operator.html#operator.index), and whenever Python needs to
losslessly convert the numeric object to an integer object (such as in
slicing, or in the built-in [`bin()`](../library/functions.html#bin), [`hex()`](../library/functions.html#hex) and [`oct()`](../library/functions.html#oct)
functions). Presence of this method indicates that the numeric object is
an integer type. Must return an integer.

If [`__int__()`](#object.__int__), [`__float__()`](#object.__float__) and [`__complex__()`](#object.__complex__) are not
defined then corresponding built-in functions [`int()`](../library/functions.html#int), [`float()`](../library/functions.html#float)
and [`complex()`](../library/functions.html#complex) fall back to `__index__()`.

**
object.__round__(*self*[, *ndigits*])[¶](#object.__round__)**

**
object.__trunc__(*self*)[¶](#object.__trunc__)**

**
object.__floor__(*self*)[¶](#object.__floor__)**

**
object.__ceil__(*self*)[¶](#object.__ceil__)**

Called to implement the built-in function [`round()`](../library/functions.html#round) and [`math`](../library/math.html#module-math)
functions [`trunc()`](../library/math.html#math.trunc), [`floor()`](../library/math.html#math.floor) and [`ceil()`](../library/math.html#math.ceil).
Unless *ndigits* is passed to `__round__()` all these methods should
return the value of the object truncated to an [`Integral`](../library/numbers.html#numbers.Integral)
(typically an [`int`](../library/functions.html#int)).

Changed in version 3.14: [`int()`](../library/functions.html#int) no longer delegates to the `__trunc__()` method.

### 3.3.9. With Statement Context Managers[¶](#with-statement-context-managers)
...
The [`object`](../library/functions.html#object) class itself does not provide the context manager methods.

**
object.__enter__(*self*)[¶](#object.__enter__)**
...
**
object.__exit__(*self*, *exc_type*, *exc_value*, *traceback*)[¶](#object.__exit__)**

Exit the runtime context related to this object. The parameters describe the
exception that caused the context to be exited. If the context was exited
without an exception, all three arguments will be [`None`](../library/constants.html#None).
...
### 3.3.10. Customizing positional arguments in class pattern matching[¶](#customizing-positional-arguments-in-class-pattern-matching)
...
**
object.__match_args__[¶](#object.__match_args__)**
...
a [`TypeError`](../library/exceptions.html#TypeError).
...
### 3.3.11. Emulating buffer types[¶](#emulating-buffer-types)
...
is implemented by builtin types such as [`bytes`](../library/stdtypes.html#bytes) and [`memoryview`](../library/stdtypes.html#memoryview),
...
**
object.__buffer__(*self*, *flags*)[¶](#object.__buffer__)**

Called when a buffer is requested from *self* (for example, by the
[`memoryview`](../library/stdtypes.html#memoryview) constructor). The *flags* argument is an integer
representing the kind of buffer requested, affecting for example whether
the returned buffer is read-only or writable. [`inspect.BufferFlags`](../library/inspect.html#inspect.BufferFlags)
provides a convenient way to interpret the flags. The method must return
a `memoryview` object.

**Thread safety:** In [free-threaded](../glossary.html#term-free-threading) Python,
...
completes. See [Thread safety for memoryview objects](../library/threadsafety.html#thread-safety-memoryview) for details.

**
object.__release_buffer__(*self*, *buffer*)[¶](#object.__release_buffer__)**

Called when a buffer is no longer needed. The *buffer* argument is a
[`memoryview`](../library/stdtypes.html#memoryview) object that was previously returned by
...
**[`collections.abc.Buffer`](../library/collections.abc.html#collections.abc.Buffer)**
ABC for buffer types.

### 3.3.12. Annotations[¶](#annotations)

Functions, classes, and modules may contain [annotations](../glossary.html#term-annotation),
which are a way to associate information (usually [type hints](../glossary.html#term-type-hint))
with a symbol.

**
object.__annotations__[¶](#object.__annotations__)**

This attribute contains the annotations for an object. It is
[lazily evaluated](executionmodel.html#lazy-evaluation), so accessing the attribute may
...
**
object.__annotate__(*format*)[¶](#object.__annotate__)**

An [annotate function](../glossary.html#term-annotate-function).
...
It must be a member of the [`annotationlib.Format`](../library/annotationlib.html#annotationlib.Format) enum, or an integer with
a value corresponding to a member of the enum.

If an annotate function doesn’t support the requested format, it must raise
[`NotImplementedError`](../library/exceptions.html#NotImplementedError). Annotate functions must always support
[`VALUE`](../library/annotationlib.html#annotationlib.Format.VALUE) format; they must not raise
[`NotImplementedError()`](../library/exceptions.html#NotImplementedError) when called with this format.

When called with [`VALUE`](../library/annotationlib.html#annotationlib.Format.VALUE) format, an annotate function may raise
[`NameError`](../library/exceptions.html#NameError); it must not raise `NameError` when called requesting any other format.
...
### 3.3.13. Special method lookup[¶](#special-method-lookup)
...
### 3.4.1. Awaitable Objects[¶](#awaitable-objects)

An [awaitable](../glossary.html#term-awaitable) object generally implements an [`__await__()`](#object.__await__) method.
[Coroutine objects](../glossary.html#term-coroutine) returned from [`async def`](compound_stmts.html#async-def) functions
are awaitable.

Note

The [generator iterator](../glossary.html#term-generator-iterator) objects returned from generators
decorated with [`types.coroutine()`](../library/types.html#types.coroutine)
are also awaitable, but they do not implement [`__await__()`](#object.__await__).

**
object.__await__(*self*)[¶](#object.__await__)**

Must return an [iterator](../glossary.html#term-iterator). Should be used to implement
[awaitable](../glossary.html#term-awaitable) objects. For instance, [`asyncio.Future`](../library/asyncio-future.html#asyncio.Future) implements
this method to be compatible with the [`await`](expressions.html#await) expression.
The [`object`](../library/functions.html#object) class itself is not awaitable and does not provide
this method.
...
(e.g. [`asyncio`](../library/asyncio.html#module-asyncio)) that will be managing the [awaitable](../glossary.html#term-awaitable) object.
...
### 3.4.2. Coroutine Objects[¶](#coroutine-objects)

[Coroutine objects](../glossary.html#term-coroutine) are [awaitable](../glossary.html#term-awaitable) objects.
A coroutine’s execution can be controlled by calling [`__await__()`](#object.__await__) and
iterating over the result. When the coroutine has finished executing and
returns, the iterator raises [`StopIteration`](../library/exceptions.html#StopIteration), and the exception’s
[`value`](../library/exceptions.html#StopIteration.value) attribute holds the return value. If the
coroutine raises an exception, it is propagated by the iterator. Coroutines
should not directly raise unhandled `StopIteration` exceptions.

Coroutines also have the methods listed below, which are analogous to
those of generators (see [Generator-iterator methods](expressions.html#generator-methods)). However, unlike
generators, coroutines do not directly support iteration.

Changed in version 3.5.2: It is a [`RuntimeError`](../library/exceptions.html#RuntimeError) to await on a coroutine more than once.

**
coroutine.send(*value*)[¶](#coroutine.send)**

Starts or resumes execution of the coroutine. If *value* is `None`,
this is equivalent to advancing the iterator returned by
[`__await__()`](#object.__await__). If *value* is not `None`, this method delegates
to the [`send()`](expressions.html#generator.send) method of the iterator that caused
the coroutine to suspend. The result (return value,
[`StopIteration`](../library/exceptions.html#StopIteration), or other exception) is the same as when
iterating over the `__await__()` return value, described above.

**
coroutine.throw(*value*)[¶](#coroutine.throw)**

**
coroutine.throw(*type*[, *value*[, *traceback*]])**

Raises the specified exception in the coroutine. This method delegates
to the [`throw()`](expressions.html#generator.throw) method of the iterator that caused
the coroutine to suspend, if it has such a method. Otherwise,
the exception is raised at the suspension point. The result
(return value, [`StopIteration`](../library/exceptions.html#StopIteration), or other exception) is the same as
...
is suspended, this method first delegates to the [`close()`](expressions.html#generator.close)
method of the iterator that caused the coroutine to suspend, if it
has such a method. Then it raises [`GeneratorExit`](../library/exceptions.html#GeneratorExit) at the
...
### 3.4.3. Asynchronous Iterators[¶](#asynchronous-iterators)

An *asynchronous iterator* can call asynchronous code in
its `__anext__` method.

Asynchronous iterators can be used in an [`async for`](compound_stmts.html#async-for) statement.

The [`object`](../library/functions.html#object) class itself does not provide these methods.

**
object.__aiter__(*self*)[¶](#object.__aiter__)**

Must return an *asynchronous iterator* object.

**
object.__anext__(*self*)[¶](#object.__anext__)**

Must return an *awaitable* resulting in a next value of the iterator. Should
raise a [`StopAsyncIteration`](../library/exceptions.html#StopAsyncIteration) error when the iteration is over.
...
[asynchronous iterator](../glossary.html#term-asynchronous-iterator).

Starting with Python 3.7, [`__aiter__()`](#object.__aiter__) must return an
asynchronous iterator object. Returning anything else
will result in a [`TypeError`](../library/exceptions.html#TypeError) error.

### 3.4.4. Asynchronous Context Managers[¶](#asynchronous-context-managers)

An *asynchronous context manager* is a *context manager* that is able to
suspend execution in its `__aenter__` and `__aexit__` methods.

Asynchronous context managers can be used in an [`async with`](compound_stmts.html#async-with) statement.

The [`object`](../library/functions.html#object) class itself does not provide these methods.

**
object.__aenter__(*self*)[¶](#object.__aenter__)**

Semantically similar to [`__enter__()`](#object.__enter__), the only
difference being that it must return an *awaitable*.

**
object.__aexit__(*self*, *exc_type*, *exc_value*, *traceback*)[¶](#object.__aexit__)**
...
[[2](#id12)]
The [`__hash__()`](#object.__hash__), [`__iter__()`](#object.__iter__),
[`__reversed__()`](#object.__reversed__), [`__contains__()`](#object.__contains__),
[`__class_getitem__()`](#object.__class_getitem__) and [`__fspath__()`](../library/os.html#os.PathLike.__fspath__)
methods have special handling for this. Others
will still raise a [`TypeError`](../library/exceptions.html#TypeError), but may do so by relying on
the behavior that `None` is not callable.

[[3](#id16)]
“Does not support” here means that the class has no such method, or
the method returns [`NotImplemented`](../library/constants.html#NotImplemented). Do not set the method to
...
(such as [`__add__()`](#object.__add__)) fails then the operation is not supported, which is why the
...
* [3.2.4. `numbers.Number`](#numbers-number)
* [3.2.4.1. `numbers.Integral`](#numbers-integral)

* [3.2.4.2. `numbers.Real` (`float`)](#numbers-real-float)

* [3.2.4.3. `numbers.Complex` (`complex`)](#numbers-complex-complex)
...
*
[Show source
](https://github.com/python/cpython/blob/main/Doc/reference/datamodel.rst?plain=1)
...
*
[next](executionmodel.html) |

*
[previous](lexical_analysis.html) |
