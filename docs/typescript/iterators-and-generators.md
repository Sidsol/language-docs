---
sourceUrl: "https://www.typescriptlang.org/docs/handbook/iterators-and-generators.html"
fetchedAt: "2026-04-19T23:34:51.991Z"
language: "TypeScript"
...
```
tsfunction toArray(xs: Iterable): X[] {  return [...xs]}
```
...
```
jsvar numbers = [1, 2, 3];for (var _i = 0; _i