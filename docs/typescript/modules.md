---
sourceUrl: "https://www.typescriptlang.org/docs/handbook/2/modules.html"
fetchedAt: "2026-04-19T23:34:51.704Z"
language: "TypeScript"
title: "Modules"
---
# Modules
...
```
ts// @filename: hello.tsexport default function helloWorld() {  console.log("Hello, world!");}Try
```
...
```
tsimport helloWorld from "./hello.js";helloWorld();Try
```
...
```
ts// @filename: maths.tsexport var pi = 3.14;export let squareTwo = 1.41;export const phi = 1.61; export class RandomNumberGenerator {} export function absolute(num: number) {  if (num `import type`
Which is an import statement which can *only* import types:


```
ts// @filename: animal.tsexport type Cat = { breed: string; yearOfBirth: number };export type Dog = { breeds: string[]; yearOfBirth: number };export const  string' >createCatName = () => "fluffy"; // @filename: valid.tsimport type { Cat, Dog } from "./animal.js";export type Animals = Cat | Dog; // @filename: app.tsimport type {  string
import createCatName' >createCatName } from "./animal.js";const name = createCatName();'createCatName' cannot be used as a value because it was imported using 'import type'.1361'createCatName' cannot be used as a value because it was imported using 'import type'.Try
```
...
```
ts// @filename: app.tsimport {  string
import createCatName' >createCatName, type Cat, type Dog } from "./animal.js"; export type Animals = Cat | Dog;const name = createCatName();Try
```
...
```
tsimport fs = require("fs");const code = fs.readFileSync("hello.ts", "utf8");Try
```
...
```
tsfunction absolute(num: number) {  if (num absolute,};Try
```
...
```
tsconst maths =  any' >require("./maths");maths.pi;      anyTry
```
...
```
tsconst { squareTwo } =  any' >require("./maths");squareTwo;   const squareTwo: anyTry
```
...
```
tsimport { valueOfPi } from "./constants.js"; export const twoPi = valueOfPi * 2;Try
```
...
```
ts"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.twoPi = void 0;const constants_js_1 = require("./constants.js");exports.twoPi = constants_js_1.valueOfPi * 2; Try
```
...
```
ts(function (factory) {    if (typeof module === "object" && typeof module.exports === "object") {        var v = factory(require, exports);        if (v !== undefined) module.exports = v;    }    else if (typeof define === "function" && define.amd) {        define(["require", "exports", "./constants.js"], factory);    }})(function (require, exports) {    "use strict";    Object.defineProperty(exports, "__esModule", { value: true });    exports.twoPi = void 0;    const constants_js_1 = require("./constants.js");    exports.twoPi = constants_js_1.valueOfPi * 2;}); Try
```
