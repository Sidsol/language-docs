---
sourceUrl: "https://www.typescriptlang.org/docs/handbook/declaration-files/publishing.html"
fetchedAt: "2026-04-19T23:34:53.225Z"
language: "TypeScript"
title: "Declaration Files - Publishing"
---
...
```
json{  "name": "package-name",  "version": "1.0.0",  "types": "./index.d.ts",  "typesVersions": {    "=3.2": { "*": ["ts3.2/*"] },    ">=3.1": { "*": ["ts3.1/*"] }  }}
```
