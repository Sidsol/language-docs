---
sourceUrl: "https://www.typescriptlang.org/docs/handbook/declaration-files/by-example.html"
fetchedAt: "2026-04-19T23:34:53.219Z"
language: "TypeScript"
title: "Declaration Files - By Example"
---
...
```
tsdeclare namespace GreetingLib.Options {  // Refer to via GreetingLib.Options.Log  interface Log {    verbose?: boolean;  }  interface Alert {    modal: boolean;    title?: string;    color?: string;  }}
```
