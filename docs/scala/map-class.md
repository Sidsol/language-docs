---
sourceUrl: "https://docs.scala-lang.org/overviews/scala-book/map-class.html"
...
The [Map class documentation](/overviews/collections-2.13/maps.html) describes a Map as an iterable sequence that consists of pairs of keys and values. A simple Map looks like this:
...
There are other ways to work with Scala Maps, and a nice collection of Map classes for different needs. See the [Map class documentation](/overviews/collections-2.13/maps.html) for more information and examples.
