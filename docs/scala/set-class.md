---
sourceUrl: "https://docs.scala-lang.org/overviews/scala-book/set-class.html"
...
The [Scala Set class](/overviews/collections-2.13/sets.html) is an iterable collection with no duplicate elements.
...
Scala has several more Set classes, including SortedSet, LinkedHashSet, and more. Please see the [Set class documentation](/overviews/collections-2.13/sets.html) for more details on those classes.
