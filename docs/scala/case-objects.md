---
sourceUrl: "https://docs.scala-lang.org/overviews/scala-book/case-objects.html"
...
Before we jump into *case objects*, we should provide a little background on “regular” Scala objects. As we mentioned early in this book, you use a Scala object when you want to create a singleton object. As [the documentation states](/tour/singleton-objects.html), “Methods and values that aren’t associated with individual instances of a class belong in singleton objects, denoted by using the keyword object instead of class.”
