---
sourceUrl: "https://docs.scala-lang.org/overviews/scala-book/collections-maps.html"
...
There are many more things you can do with maps. See the [Map class documentation](/overviews/collections-2.13/maps.html) for more details and examples.
